...
$(project):
	@${CHECK_DIR_CMD}
	protoc --proto_path=. --go_opt=paths=source_relative --go_opt=module=${PACKAGE} --go_out=. --go-grpc_opt=module=${PACKAGE} --go-grpc_out=. $@/${PROTO_DIR}/*.proto
...
gen:
	...
	--go_opt=module=github.com/vinay03/grpc-go-course \
	--go-grpc_out=. \
	--go-grpc_opt=module=github.com/vinay03/grpc-go-course \
	greet/proto/dummy.proto
	# mv *.pb.go greet/proto
